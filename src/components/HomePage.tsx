    ...
    <div className="min-h-screen bg-background">
      <SEOHead
        seo={{
          ...
          description:
            'Learn AI, Machine Learning, and Deep Learning with interactive flashcards, spaced repetition, and structured learning paths.',
      ...
      {isAuthenticated ? (
        <UserHero onNavigate={onNavigate} sessionData={lastSession} isLoading={loadingSession} />
      ) : (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              {isAuthenticated
                ? 'Continue where you left off or explore new domains'
