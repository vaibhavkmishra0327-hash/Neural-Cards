...
export function QuizHub() {
  ...
  const modes = [
    ...
    {
      id: 'ai-quiz' as QuizMode,
      title: 'AI-Powered Quiz',
      description: 'Smart questions generated by AI with detailed explanations',
      icon: Sparkles,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p>
              ...
              test understanding, <strong>Fill-in-the-Blank</strong> for deep recall, and{' '}
              <strong>AI Quiz</strong> for challenging, personalised questions.
            </p>
          </motion.div>
        </div>
      </div>
