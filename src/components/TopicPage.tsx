    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-3">
                <span
                  className={`px-3 py-1 rounded-full text-xs font-semibold ${difficultyColors[topic.difficulty]}`}
                >
                  {topic.difficulty}
                </span>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-4">{topic.description}</p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-4xl mx-auto">
          {activeTab === 'overview' && <OverviewTab topic={topic} flashcards={flashcards} />}
      ...
      {topic.prerequisites && topic.prerequisites.length > 0 && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2">Prerequisites</h3>
      ...
      <div>
        ...
        <div className="space-y-4">
          {flashcards.slice(0, 3).map((card) => (
            <div
              key={card.id}
              className="p-6 bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700"
            >
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">All Flashcards</h2>
        <div className="text-sm text-gray-600 dark:text-gray-400">{flashcards.length} cards</div>
      </div>

      {flashcards.map((card, index) => (
        <div
          key={card.id}
          className="p-6 bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600 transition-all"
        >
            ...
            <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
              ...
              <ul className="space-y-1">
                {card.pitfalls.map((pitfall, i) => (
                  <li
                    key={i}
                    className="text-sm text-yellow-900 dark:text-yellow-200 flex items-start gap-2"
                  >
